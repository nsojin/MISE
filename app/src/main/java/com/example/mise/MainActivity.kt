...
import com.example.mise.data.DustItem
import com.example.mise.databinding.ActivityMainBinding
import com.example.mise.retrofit.NetWorkClient
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setUpDustParameter(sido: String): HashMap<String, String> {
        val authKey =
            "qI6MpQDtYKnb2pqbj+rylCkWgWdhNTd3O3VIBl8hiUrih7q/L2sJVzE94IYTfjgiXZmqPGmskoB66oVY2CWIMA=="
